      ...
      <div class="espacioFormLogin  p-3 text-left">
        <div class="icono text-center">
          ...
          <p class="indicacionesRegistro">
            En este registro, puedes cambiar el PIN con el que desactivarás la
            alerta de tu
            <router-link to="/sobre-eyes-on">
              Dispositivo Rastreador</router-link
            >
            en caso de ser activado.
          </p>
          ...
          <b-form name="form" id="form" v-on:submit.prevent="procesar()">
            ...
            >
              <h6>
                PIN cambiado correctamente. Serás redirigida al menú de Usuaria.
              </h6>
            </div>
...
export default {
  ...
  data() {
    return {
      titulo: "Cambiar PIN Dispositivo Rastreador | Eyes On",
      submited: false,
      dispositivo: {
        numero_serie: "",
        pin_desactivador: "",
  ...
  methods: {
    ...
    peticion() {
      ...
      console.log(json);
      axios({
        url: "https://backend-upiita.herokuapp.com/dispositivo/cambiarpin/",
        method: "patch",
        data: json,
        headers: {
          Authorization: token,
        ...
        .then((data) => {
          ...
          Swal.fire({
            ...
            text: "Para desactivar tu alerta, deberás ingresar el nuevo PIN.",
            confirmButtonColor: "#a5b232",
          });
          this.redireccionar();
        })
        .catch((error) => {
          ...
          Swal.fire({
            ...
            text: "Inténtalo en unos minutos más.",
            confirmButtonColor: "#a5b232",
          });
