      ...
      <div class="espacioFormLogin  p-3 text-left">
        <div class="icono text-center">
          ...
          <p class="indicacionesRegistro">
            Estás a punto de eliminar tu cuenta. ¿Estás de acuerdo?
          </p>

          <hr />
          <b-form name="form" id="form" v-on:submit.prevent="eliminarPersona()">
            <!--Boton enviar-->
            <div class="espacioBtnLogin text-center">
              <b-button pill class="submit " type="submit">Continuar</b-button>
            </div>
            ...
            >
              <h6>
                Se ha eliminado tu cuenta exitosamente. Serás redirigido al
                Inicio.
              </h6>
            </div>
            ...
            >
              <h6>{{ mensaje_error }}</h6>
              <h6>
                No se pudo completar tu petición. Intentar de nuevo.
              </h6>
            </div>
          </b-form>
      ...
      let url = axios({
        ...
        .then((data) => {
          Swal.fire({
            ...
            text: "Se te redirigirá al inicio.",
            confirmButtonColor: "#a5b232",
          });
