    ...
    >
      <div class="espacioFormUsuaria  p-3 text-left">
        ...
        <b-form name="form" id="form" v-on:submit.prevent="procesar()">
          ...
          >
            <h6>
              Se han actualizado tus datos correctamente. Serás redirigida al
              Menú Principal.
            </h6>
          </div>

          <div class="espacioBtnLogin text-center">
            <b-button pill class="submit" type="submit">Actualizar</b-button>
          </div>
...
export default {
  ...
  data() {
    return {
      titulo: "Modificar Datos de Usuaria | Eyes On",
      submited: false,
      usuaria: {
        estatura: "",
        escolaridad: "",
    ...
    obtenerInfoUsuaria() {
      ...
      axios({
        ...
        .then((data) => {
          ...
          //console.log(data.data.enfermedades[0].nombre_enfermedad);
          let enfermedadUsuaria = data.data.enfermedades[0].nombre_enfermedad;
          this.usuaria.enfermedades.enfermedades = enfermedadUsuaria;
        })
        .catch((error) => {
          console.error(error);
        });
    ...
    procesar() {
      ...
      axios({
        ...
        .then((data) => {
          ...
          Swal.fire({
            icon: "success",
            title: "Datos de Usuaria actualizados correctamente",
            text: "Podrás visualizar tu información en Configuración.",
            confirmButtonColor: "#a5b232",
          });
          this.redireccionar();
        })
        .catch((error) => {
          ...
          Swal.fire({
            icon: "error",
            title: "Error al actualizar datos de Usuaria",
